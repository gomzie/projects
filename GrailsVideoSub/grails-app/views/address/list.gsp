			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="address3" title="${message(code: 'address.address3.label', default: 'Address3')}" />
						...
						<g:sortableColumn property="postCode" title="${message(code: 'address.postCode.label', default: 'Post Code')}" />
				...
				<g:each in="${addressInstanceList}" status="i" var="addressInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: addressInstance, field: "address3")}</td>
