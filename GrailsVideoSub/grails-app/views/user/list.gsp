			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="firstName" title="${message(code: 'user.lastName.label', default: 'Name')}" />
						
						<g:sortableColumn property="organization" title="${message(code: 'user.organization.label', default: 'Organization')}" />
						
						<g:sortableColumn property="jobTitle" title="${message(code: 'user.jobTitle.label', default: 'Job Title')}" />
						
						<g:sortableColumn property="phoneNumber" title="${message(code: 'phoneNumber.label', default: 'Phone Number')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: userInstance, field: "jobTitle")}</td>
